...
import static org.cryo.core.graphics.material.CsMaterialInstanceNative.*;

@CsClass(CS_CLASS_NAME)
public class CsMaterialInstance extends IMaterial {
    ...
    public CsMaterial getMaterial () {
        return (CsMaterial)nGetMaterial(getRef());
    }
