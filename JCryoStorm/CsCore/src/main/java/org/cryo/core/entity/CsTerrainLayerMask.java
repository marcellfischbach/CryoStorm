...
import static org.cryo.core.entity.CsTerrainLayerMaskNative.*;

@CsClass(CS_CLASS_NAME)
public class CsTerrainLayerMask extends CsObject {

    public CsTerrainLayerMask() {
    }

    public CsTerrainLayerMask(long ref) {
        super(ref);
    }
