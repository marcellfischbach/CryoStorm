...
#include <csEditor/assetbrowser/AssetBrowserTreeModel.hh>
#include <csEditor/assetbrowser/AssetBrowserNewItemDialog.hh>
...
#include <csEditor/ui_AssetBrowserWidget.h>
