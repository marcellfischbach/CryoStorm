...
void generate_test_brickwall(cs::csWorld* world)
{
  auto brickWall = csAssetManager::Get()->Get<csEntity>("/brickwall/brickwall.entity");
  if (!brickWall)
  {
    printf("Unable to load brickwall entity\n");
    return;
  }

  world->Attach(brickWall.Data());
