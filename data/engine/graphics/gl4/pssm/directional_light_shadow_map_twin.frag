...
float calc_directional_shadow(int splitView, vec3 world_position, float distance_to_camera)
{
...
void main ()
{
    ...
    int splitView = texCoord.x <= 0.5 ? 0 : 1;

    float shadow = calc_directional_shadow(splitView, world_position.xyz, camera_space.z);
