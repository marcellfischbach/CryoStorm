...
//	for (int i=0; i<6; i++)
	...
	{
		gl_Layer = 3;
		gl_Position = spc_ShadowMapViewProjectionMatrix[3] * gl_in[0].gl_Position;
		EmitVertex();
		gl_Position = spc_ShadowMapViewProjectionMatrix[3] * gl_in[1].gl_Position;
		EmitVertex();
		gl_Position = spc_ShadowMapViewProjectionMatrix[3] * gl_in[2].gl_Position;
		EmitVertex();
		EndPrimitive();
	}
	{
		gl_Layer = 4;
		gl_Position = spc_ShadowMapViewProjectionMatrix[4] * gl_in[0].gl_Position;
		EmitVertex();
		gl_Position = spc_ShadowMapViewProjectionMatrix[4] * gl_in[1].gl_Position;
		EmitVertex();
		gl_Position = spc_ShadowMapViewProjectionMatrix[4] * gl_in[2].gl_Position;
		EmitVertex();
		EndPrimitive();
	}
	{
		gl_Layer = 5;
		gl_Position = spc_ShadowMapViewProjectionMatrix[5] * gl_in[0].gl_Position;
		EmitVertex();
		gl_Position = spc_ShadowMapViewProjectionMatrix[5] * gl_in[1].gl_Position;
		EmitVertex();
		gl_Position = spc_ShadowMapViewProjectionMatrix[5] * gl_in[2].gl_Position;
		EmitVertex();
		EndPrimitive();
	}
