...
CS_CLASS_GEN;
  ...
  virtual void SetShader(csAssetRef<cs::iShader> &shader) = 0;
...
//  virtual void SetLightShadowMap(iLight *light, iTexture2D *shadowMap) = 0;
  ...
  virtual eTextureUnit BindTexture(csAssetRef<const cs::iTexture2D> &texture) = 0;
  virtual bool BindMaterial(const csAssetRef<iMaterial> &material, eRenderPass pass) = 0;
