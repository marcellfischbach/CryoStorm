...
private:
  ...
  csOwned<csSGNode> CreateNode(const csCryoFileElement * nodeElement, csShaderGraph * sg) const;
  csOwned<csSGResourceNode> CreateResourceNode(const csCryoFileElement * nodeElement, csShaderGraph * sg) const;
