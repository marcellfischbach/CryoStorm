...
csGL4TwinPSSMFilter::csGL4TwinPSSMFilter()
{
...
bool csGL4TwinPSSMFilter::Initialize(const csVector2f &distance, float radius, float samplesFactor, float maxSampleDistance)
{
  m_distance          = distance;
  m_radius            = radius;
  ...
  m_shadowMapFilterShader = csAssetManager::Get()->Get<iShader>(
      csAssetLocator("/graphics/gl4/pssm/directional_light_shadow_map_filter.shader")
  );
...
void csGL4TwinPSSMFilter::Render(csGL4Device *device,
