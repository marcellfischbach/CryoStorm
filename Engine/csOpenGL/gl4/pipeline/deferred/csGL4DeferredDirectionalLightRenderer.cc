...
bool csGL4DeferredDirectionalLightRenderer::Initialize()
{
  ...
  m_nonShadow.m_shader = csAssetManager::Get()->Get<iShader>(
      csResourceLocator("${engine}/opengl/gl4/deferred/directional_light_deferred_no_shadow.shader"));
  ...
  m_shadow.m_shader = csAssetManager::Get()->Get<iShader>(
      csResourceLocator("${engine}/opengl/gl4/deferred/directional_light_deferred_shadow.shader"));
