...
#include <ceOpenGL/gl4/shadergraph/csGL4ShaderGraphCompiler.hh>
...
std::string csGL4ShaderGraphCompiler::GenerateGBuffer_Vert(std::map<std::string, eMaterialAttributeType> &attributes)
{
  std::string src;
...
std::string csGL4ShaderGraphCompiler::GenerateGBuffer_Geom(std::map<std::string, eMaterialAttributeType> &attributes)
{
  std::string src;
...
std::string csGL4ShaderGraphCompiler::GenerateGBuffer_Frag(std::map<std::string, eMaterialAttributeType> &attributes)
{
  std::string src;
...
void csGL4ShaderGraphCompiler::GenerateGBuffer(csGL4ShaderGraphCompiler::SourceBundle &bundle)
{
