...
#include <ceOpenGL/gl4/pipeline/deferred/csGL4DeferredDirectionalLightRenderer.hh>
#include <ceOpenGL/gl4/pipeline/deferred/csGL4DeferredPointLightRenderer.hh>
