...
#include <cecore/math/cevector4f.hh>


struct CEC_API ceMatrix4f
{
public:
  float m00;
  float m01;
...
public:
  CE_FORCEINLINE ceMatrix4f(const float* f)
    : m00(f[0])
    , m01(f[1])
    , m02(f[2])
    , m03(f[3])
  ...
  CE_FORCEINLINE ceMatrix4f(float m00 = 1.0f, float m01 = 0.0f, float m02 = 0.0f, float m03 = 0.0f, float m10 = 0.0f, float m11 = 1.0f, float m12 = 0.0f, float m13 = 0.0f, float m20 = 0.0f, float m21 = 0.0f, float m22 = 1.0f, float m23 = 0.0f, float m30 = 0.0f, float m31 = 0.0f, float m32 = 0.0f, float m33 = 1.0f)
    : m00(m00)
    , m01(m01)
    , m02(m02)
    , m03(m03)
  ...
  CE_FORCEINLINE void Set(float m00 = 1.0f, float m01 = 0.0f, float m02 = 0.0f, float m03 = 0.0f, float m10 = 0.0f, float m11 = 1.0f, float m12 = 0.0f, float m13 = 0.0f, float m20 = 0.0f, float m21 = 0.0f, float m22 = 1.0f, float m23 = 0.0f, float m30 = 0.0f, float m31 = 0.0f, float m32 = 0.0f, float m33 = 1.0f)
  {
    this->m00 = m00;
    this->m01 = m01;
    this->m02 = m02;
  ...
  CE_FORCEINLINE void Set(const ceMatrix4f& matrix)
  {
    m00 = matrix.m00;
    m01 = matrix.m01;
    m02 = matrix.m02;
  ...
  CE_FORCEINLINE void SetXAxis(const ceVector3f& v)
  {
    m00 = v.x;
    m01 = v.y;
    m02 = v.z;
  ...
  CE_FORCEINLINE void SetYAxis(const ceVector3f& v)
  {
    m10 = v.x;
    m11 = v.y;
    m12 = v.z;
  ...
  CE_FORCEINLINE void SetZAxis(const ceVector3f& v)
  {
    m20 = v.x;
    m21 = v.y;
    m22 = v.z;
  ...
  CE_FORCEINLINE ceVector3f& GetXAxis(ceVector3f& res) const
  {
    res.x = m00;
    res.y = m01;
    res.z = m02;
  ...
  CE_FORCEINLINE ceVector3f& GetYAxis(ceVector3f& res) const
  {
    res.x = m10;
    res.y = m11;
    res.z = m12;
  ...
  CE_FORCEINLINE ceVector3f& GetZAxis(ceVector3f& res) const
  {
    res.x = m20;
    res.y = m21;
    res.z = m22;
  ...
  CE_FORCEINLINE ceVector3f& GetAxis(ceUInt8 axis, ceVector3f& res) const
  {
    switch (axis)
    {
    case 0:
  ...
  CE_FORCEINLINE void SetTranslation(const ceVector3f& tr, float w = 1.0f)
  {
    m30 = tr.x;
    m31 = tr.y;
    m32 = tr.z;
  ...
  CE_FORCEINLINE ceVector3f& GetTranslation(ceVector3f& res) const
  {
    res.x = m30;
    res.y = m31;
    res.z = m32;
  ...
  CE_FORCEINLINE ceMatrix4f& SetRotationX(float angle)
  {
  ...
  CE_FORCEINLINE ceMatrix4f& SetRotationY(float angle)
  {
    float c = (float)cos(angle);
    float s = (float)sin(angle);
    m00 = c;
  ...
  CE_FORCEINLINE ceMatrix4f& SetRotationZ(float angle)
  {
    float c = (float)cos(angle);
    float s = (float)sin(angle);
    m00 = c;
  ...
  CE_FORCEINLINE ceMatrix4f& SetRotation(const ceVector3f& axis, float angle)
  {
    float c = cosf(angle);
    float s = sinf(angle);
  ...
  CE_FORCEINLINE ceMatrix4f& Inverted(ceMatrix4f& res) const
  {
  ...
  CE_FORCEINLINE ceMatrix4f & Invert()
  {
    float v0 = m20 * m31 - m21 * m30;
    float v1 = m20 * m32 - m22 * m30;
    float v2 = m20 * m33 - m23 * m30;
  ...
  CE_FORCEINLINE ceMatrix4f Transposed() const
  {
    return ceMatrix4f(
      m00, m10, m20, m30,
      m01, m11, m21, m31,
...
#define SWAP(a, b, s) (s) = (a); (a)=(b); (b)=(s)
  CE_FORCEINLINE ceMatrix4f & Transpose()
  {
    float s;
    SWAP(m01, m10, s);
    SWAP(m02, m20, s);
...
#undef SWAP
  ...
  CE_FORCEINLINE ceMatrix4f& SetLookAt(const ceVector3f & eye, const ceVector3f & spot, const ceVector3f & up)
  {
    ceVector3f xAxis, yAxis, zAxis;
    ceVector3f::Sub(eye, spot, zAxis).Normalize();
    ceVector3f::Cross(up, zAxis, xAxis).Normalize();
    ceVector3f::Cross(zAxis, xAxis, yAxis);

    ceVector3f::Sub(spot, eye, yAxis).Normalize();
    ceVector3f::Cross(yAxis, up, xAxis).Normalize();
    ceVector3f::Cross(xAxis, yAxis, zAxis);
  ...
  CE_FORCEINLINE ceMatrix4f& SetLookAtInv(const ceVector3f & eye, const ceVector3f & spot, const ceVector3f & up)
  {
    ceVector3f xAxis, yAxis, zAxis;
    ceVector3f::Sub(eye, spot, zAxis).Normalize();
    ceVector3f::Cross(up, zAxis, xAxis).Normalize();
  ...
  CE_FORCEINLINE static ceMatrix4f& Mult(const ceMatrix4f & m0, const ceMatrix4f & m1, ceMatrix4f & r)
  {
  ...
  static ceVector3f& Mult(const ceMatrix4f & m, const ceVector3f & v, ceVector3f & res)
  {
  ...
  static ceVector3f& Transform(const ceMatrix4f & m, const ceVector3f & v, ceVector3f & res)
  {
    res.Set(
  ...
  static ceVector4f& Mult(const ceMatrix4f & m, const ceVector4f & v, ceVector4f & res)
  {
  ...
  CE_FORCEINLINE void Debug(const char* message = 0) const
  {
    if (message)
    {
      printf("csMatrix: %s\n", message);
  ...
  CE_FORCEINLINE bool IsIdentity() const
  {
