...
public:
  CE_FORCEINLINE ceMatrix3f(const float* f)
    : m00(f[0])
    , m01(f[1])
    , m02(f[2])
    , m10(f[3])
  ...
  CE_FORCEINLINE ceMatrix3f(float m00 = 1.0f, float m01 = 0.0f, float m02 = 0.0f, float m10 = 0.0f, float m11 = 1.0f, float m12 = 0.0f, float m20 = 0.0f, float m21 = 0.0f, float m22 = 1.0f)
    : m00(m00)
    , m01(m01)
    , m02(m02)
    , m10(m10)
  ...
  CE_FORCEINLINE static ceMatrix3f& Mult(const ceMatrix3f& m0, const ceMatrix3f& m1, ceMatrix3f& r)
  {
  ...
  static ceVector3f& Mult(const ceMatrix3f& m, const ceVector3f& v, ceVector3f& res)
  {
