...
public:
		SPC_FORCEINLINE Matrix3f(const float *f)
						: m00(f[0]), m01(f[1]), m02(f[2]), m10(f[3]), m11(f[4]), m12(f[5]), m20(f[6]), m21(f[7]), m22(f[8])
		{
		}

		SPC_FORCEINLINE Matrix3f(float m00 = 1.0f, float m01 = 0.0f, float m02 = 0.0f, float m10 = 0.0f, float m11 = 1.0f,
		...
		SPC_FORCEINLINE Matrix3f &
		Set(float m00 = 1.0f, float m01 = 0.0f, float m02 = 0.0f, float m10 = 0.0f, float m11 = 1.0f, float m12 = 0.0f,
		...
		SPC_FORCEINLINE Matrix3f & SetXAxis(float x, float y, float z)
		{
			m00 = x;
			m01 = y;
			m02 = z;
		...
		SPC_FORCEINLINE Matrix3f & SetXAxis(const Vector3f &v)
		{
			m00 = v.x;
			m01 = v.y;
			m02 = v.z;
		...
		SPC_FORCEINLINE Matrix3f & SetYAxis(float x, float y, float z)
		{
			m10 = x;
			m11 = y;
			m12 = z;
		...
		SPC_FORCEINLINE Matrix3f & SetYAxis(const Vector3f &v)
		{
			m10 = v.x;
			m11 = v.y;
			m12 = v.z;
		...
		SPC_FORCEINLINE Matrix3f & SetZAxis(float x, float y, float z)
		{
			m20 = x;
			m21 = y;
			m22 = z;
		...
		SPC_FORCEINLINE Matrix3f & SetZAxis(const Vector3f &v)
		{
			m20 = v.x;
			m21 = v.y;
			m22 = v.z;
  ...
  SPC_FORCEINLINE friend Vector3f operator*(const Vector3f &v, const Matrix3f &m)
  {
