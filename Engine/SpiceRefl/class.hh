...
#define SPICE_CLASS(...)
#define SPICE_CLASS(...)
#define SPICE_SUPER(Cls) Cls
#define SPICE_PROPERTY(...)
#define SPICE_FUNCTION(...)
#define SPICE_CLASS_GEN public: \
    virtual const Spice::Class *GetClass () const;\
    static const Spice::Class *GetStaticClass (); \
    virtual void *QueryClass(const Spice::Class *clazz); \
    virtual const void *QueryClass(const Spice::Class *clazz) const

#define SPICE_CLASS_GEN_OBJECT \
    SPICE_CLASS_GEN; \
    virtual void AddRef() \
    { \
      m_refCount++; \
...
#define SPICE_CLASS_GEN_CONSTR m_refCount = 1

#define SPICE_WEAK_OBJECT(Super) \
  public: void AddRef () { Super::AddRef (); }\
          void Release () { Super::Release (); }


#define SPICE_SET(oo, no) if (no) no->AddRef(); if (oo) oo->Release(); oo = no
#define SPICE_ADDREF(o) if (o) o->AddRef()
#define SPICE_RELEASE(o) if (o) o->Release()
...
template<typename T>
T* QueryClass(Spice::iObject* object)
{
  if (!object)
  {
    return 0;
...
template<typename T>
const T* QueryClass(const Spice::iObject* object)
{
  if (!object)
  {
    return 0;
...
public:
  ...
  template<typename T>
  void Set(Spice::iObject* object, T& t) const
  {
  ...
  template<typename T>
  T Get(Spice::iObject* object) const
  {
  ...
  template<typename T>
  T Get(const Spice::iObject* object) const
  {
...
protected:
  ...
  virtual void SetValue(Spice::iObject* object, void* data) const = 0;
  virtual const void* GetValue(const Spice::iObject* object) const = 0;
  virtual void* GetValue(Spice::iObject* object) const = 0;
...
public:
  ...
  void InvokeVoid(Spice::iObject* obj, Type ... args) const { InvokeVoidImpl(obj, &args...); }
  template<typename ... Type>
  void InvokeVoid(const Spice::iObject* obj, Type ... args) const { InvokeVoidImpl(obj, &args...); }
  ...
  R InvokeValue(Spice::iObject* obj, Type ... args) const { R r; InvokeValueImpl(obj, &args...); return r; }
  template<typename R, typename ... Type>
  R InvokeValue(const Spice::iObject* obj, Type ... args) const { R r; InvokeValueImpl(obj, &args...); return r; }


  //
  // Invoke reference 
  template<typename R, typename ... Types>
  R& InvokeReference(Spice::iObject* obj, Types ... args) const { return *reinterpret_cast<R*>(InvokeReferenceImpl(obj, &args...)); }
  template<typename R, typename ... Types>
  R& InvokeReference(const Spice::iObject* obj, Types ... args) const { return *reinterpret_cast<R*>(InvokeReferenceImpl(obj, &args...)); }

  //
  // Invoke const-reference 
  template<typename R, typename ... Types>
  const R& InvokeConstReference(Spice::iObject* obj, Types ... args) const { return *reinterpret_cast<const R*>(InvokeConstReferenceImpl(obj, &args...)); }
  template<typename R, typename ... Types>
  const R& InvokeConstReference(const Spice::iObject* obj, Types ... args) const { return *reinterpret_cast<const R*>(InvokeConstReferenceImpl(obj, &args...)); }
  ...
  // Invoke pointer 
  template<typename R, typename ... Types>
  R* InvokePointer(Spice::iObject* obj, Types ... args) const { return reinterpret_cast<R*>(InvokePointerImpl(obj, &args...)); }
  template<typename R, typename ... Types>
  R* InvokePointer(const Spice::iObject* obj, Types ... args) const { return reinterpret_cast<R*>(InvokePointerImpl(obj, &args...)); }

  //
  // Invoke const-pointer 
  template<typename R, typename ... Types>
  const R* InvokeConstPointer(Spice::iObject* obj, Types ... args) const { return reinterpret_cast<const R*>(InvokeConstPointerImpl(obj, &args...)); }
  template<typename R, typename ... Types>
  const R* InvokeConstPointer(const Spice::iObject* obj, Types ... args) const { return reinterpret_cast<const R*>(InvokeConstPointerImpl(obj, &args...)); }
...
protected:
  ...
  virtual void InvokeVoidImpl(Spice::iObject* obj, ...) const = 0;
  virtual void InvokeVoidImpl(const Spice::iObject* obj, ...) const = 0;
  virtual void InvokeValueImpl(Spice::iObject* obj, ...) const = 0;
  virtual void InvokeValueImpl(const Spice::iObject* obj, ...) const = 0;
  virtual void* InvokeReferenceImpl(Spice::iObject* obj, ...) const = 0;
  virtual void* InvokeReferenceImpl(const Spice::iObject* obj, ...) const = 0;
  virtual const void* InvokeConstReferenceImpl(Spice::iObject* obj, ...) const = 0;
  virtual const void* InvokeConstReferenceImpl(const Spice::iObject* obj, ...) const = 0;
  virtual void* InvokePointerImpl(Spice::iObject* obj, ...) const = 0;
  virtual void* InvokePointerImpl(const Spice::iObject* obj, ...) const = 0;
  virtual const void* InvokeConstPointerImpl(Spice::iObject* obj, ...) const = 0;
  virtual const void* InvokeConstPointerImpl(const Spice::iObject* obj, ...) const = 0;
...
public:
  virtual ~Class();
  virtual Spice::iObject* CreateInstance() const = 0;
  template<typename T>
  T* CreateInstance() const
  {
    Spice::iObject* obj = CreateInstance();
    if (!obj)
    {
      return 0;
    }

    T* t = Spice::QueryClass<T>(obj);
    if (!t)
    {
      obj->Release();
      obj = nullptr;
