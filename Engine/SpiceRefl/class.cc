...
const Spice::Class* iObject::GetClass() const
{
  return Spice::iObjectClass::Get();
}

const Spice::Class* iObject::GetStaticClass()
{
  return Spice::iObjectClass::Get();
}
...
Spice::iObject* iObjectClass::CreateInstance() const
{
