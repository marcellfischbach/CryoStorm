...
JNICALL Java_org_crimsonedge_core_graphics_shading_IShaderAttribute_nGetName(JNIEnv *env,
                                                                             ...
                                                                             jlong ref)
{
  auto              attribute = reinterpret_cast<ce::iShaderAttribute *>(ref);
...
{
  auto attribute = reinterpret_cast<ce::iShaderAttribute *>(ref);
  attribute->SetArrayIndex((ce::Size)index);
}
                                                                              ...
                                                                              jfloatArray floatArray)
{
  ...
  attribute->Bind(*reinterpret_cast<const ce::Matrix3f*>(m));
                                                                                  ...
                                                                                  jfloatArray floatArray)
{
  auto attribute = reinterpret_cast<ce::iShaderAttribute *>(ref);
  jfloat *m      = env->GetFloatArrayElements(floatArray, 0);
  attribute->Bind(*reinterpret_cast<const ce::Matrix4f*>(m));
  env->ReleaseFloatArrayElements(floatArray, m, 0);
}
