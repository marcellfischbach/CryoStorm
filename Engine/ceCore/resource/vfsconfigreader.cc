...
void VFSConfigReader::ReadArchives(const cryo::CrimsonFileElement *archivesElement)
{
...
void VFSConfigReader::ReadArchive(const cryo::CrimsonFileElement *archiveElement)
{
