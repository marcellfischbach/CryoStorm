...
#define CHECK_IDX(tokens, idx) if ((idx) >= tokens.size()) throw cs::moc::ParseException(__FILE__, __LINE__, "Index out of bounds " + std::to_string(idx) + " >= " + std::to_string(tokens.size()), 0, 0)
